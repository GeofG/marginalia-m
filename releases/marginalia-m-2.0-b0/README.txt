...
please see the Marginalia web site as webmarginalia.net.
...
CREDITS.txt - a list of people and organizations who assisted in the development of Marginalia
LICENSE.txt - the GNU General Public License version 3
INSTALL.txt - installation instructions
CHANGES.txt - changes and bugfixes in this release


Most of the code is Copyright (c) 2005-2008 Geoffrey Glass and the United 
Nations.
...
refinements and may notice the software running slower for large numbers of
annotations.
