...
abstract class mia_page_profile
{
	...
	public function margin_js( )
	{
		...
		$ssessioncookie = s($CFG->sessioncookie);
...
SCRIPT;
	...
	function emit_margin_controls( )
	{
		...
		echo "<div class='discussioncontrol'>&#160;</div><div class='discussioncontrol'>&#160;</div>\n";
		echo "<select name='ansheet' class='discussioncontrol' id='ansheet' onchange='window.moodleMarginalia.changeSheet(this,\"".$refurl."\");'>\n";
...
class mia_profile_forum_display extends mia_page_profile
{
	...
	public function __construct( $moodlemia, $url, $object_type, $object_id )
	{
